...
function playAll(songNumber){
    ...
    if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
        ...
        if (songNumber === 1) {
            ...
            bannerHeading.textContent = "Dil Ka Telephone- Dream Girl 2";
            bannerText.textContent = "By Meet Bros, Nakash Aziz, Jonita Gandhi";
        } else if (songNumber === 2) {
            banner.style.backgroundImage = "url(images/b02.png)";
            bannerImage.setAttribute("src", "images/image 2.png");
            bannerHeading.textContent = "Jawan Title Track)";
            bannerText.textContent = "By Anirudh";
        }
